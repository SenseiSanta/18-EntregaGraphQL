...
import { getMainInfo, loginPage, loginPageError,
   ...
   generateRandomProd, getServerInfo, getRandomThrows,
   renderGraphQL } from '../controllers/initial.controllers.js';
...
//Renderizado de la API GraphQL
routerInitial.get('/graphql', renderGraphQL)
